...
[ -f cache/wikidata.pkl ]  || python3 tools/extract_wikidata.py core mathematics chemistry biology medicine cache/wikidata.pkl   # bounded P279 pulls, tools/fetch_wikidata.py
