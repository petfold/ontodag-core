...
def main():
    ...
    # Prune parents another parent already entails: `activated-carbon ⊑ carbon` makes
    ...
    # spot check — the raw file had made a specific edge look coarse). In a pack
    # the core's edges count; in core (2026-09-07, the services layer: CPC and
    # Wikidata witness `X ⊑ service` beside `X ⊑ hairdressing ⊑ … ⊑ service`)
    # the pack's own accepted edges do. Entailment is unchanged either way.
    core_par = {}
    if dirs.pack:
